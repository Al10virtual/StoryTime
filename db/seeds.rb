...
file1 = {io: File.open("public/speech/elodie_et_l_ours_gentil.mp3"), filename: "bonjour"}
...
s1.audio.attach(file1)

puts "Story 1 created!"

file2 = {io: File.open("public/speech/elodie_et_l_ours_gentil.mp3"), filename: "bonjour"}
...
file3 = {io: File.open("public/speech/elodie_et_l_ours_gentil.mp3"), filename: "bonjour"}


s3.audio.attach(file3)
...
file4 = {io: File.open("public/speech/elodie_et_l_ours_gentil.mp3"), filename: "bonjour"}

s4.audio.attach(file4)
...
Answer.create!(
  content: "L'école de Léon",
  kid: Kid.first,
  question: question5
)

Answer.create!(
  content: "Dua Lipa - Dance The Night",
  kid: Kid.first,
  question: question6
)
